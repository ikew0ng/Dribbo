...
public class StaggeredGridView extends ViewGroup {
    ...
    public StaggeredGridView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            mDrawSelectorOnTop = a.getBoolean(R.styleable.StaggeredGridView_drawSelectorOnTop,
                    false);
    ...
    private void useDefaultSelector() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            int[] drawableAttr = new int[] {
                android.R.attr.selectableItemBackground
            };
            TypedArray typedArray = getContext().obtainStyledAttributes(drawableAttr);
            Drawable selector = typedArray.getDrawable(0);
            typedArray.recycle();
